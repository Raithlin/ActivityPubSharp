...
{
    public TentativeRejectActivity() => Entity = TypeMap.Add<TentativeRejectActivityEntity>();
...
public sealed class TentativeRejectActivityEntity : IHasNonEntity<TentativeRejectActivity>
{
